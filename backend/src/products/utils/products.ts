...
export const PRODUCTS: Product[] = [
  {
    ...
    currency: 'CAD',
    description:
      'Simple personal tax return for salary and student income.',
    bestFor: [
...

  {
    ...
    currency: 'CAD',
    description:
      'Ideal for common deductions and employment-related expenses.',
    bestFor: [
      'Medical expenses',
      'Donations',
      'Employment expenses',
...

  {
    ...
    currency: 'CAD',
    description:
      'For users with investments, rental income, foreign income and capital gains.',
    bestFor: [
      'Investment income',
      'Rental income',
      'Capital gains',
...

  {
    ...
    currency: 'CAD',
    description:
      'Designed for freelancers, contractors, gig workers and sole proprietors.',
    bestFor: [
      'Freelancers',
      'Contractors',
      'Gig workers',
...

  {
    ...
    currency: 'CAD',
    description:
      'File your taxes yourself with support from tax experts.',
    bestFor: [
      'Expert guidance',
      'Expert review',
      'Expert chat',
...

  {
    ...
    currency: 'CAD',
    description:
      'An expert prepares and files your return for you.',
    bestFor: [
      'Hands-off filing',
      'Expert preparation',
      'Expert filing',
...

  {
    ...
    currency: 'CAD',
    description:
      'Corporate tax return solution for incorporated companies.',
    bestFor: [
...

  {
    ...
    currency: 'CAD',
    description:
      'Corporate filing for incorporated companies with no revenue.',
    bestFor: [
